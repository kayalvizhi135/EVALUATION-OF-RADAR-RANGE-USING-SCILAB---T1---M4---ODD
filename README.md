...
title("RADAR Received Power vs Target 

Range");

xgrid();

// Plot 2: Maximum Radar Range vs
Transmitted Power

P = 1:1000;

Rmax = ((P*Gt*Gr*lambda^2*sigma) ./ 
...
title("Maximum RADAR Range vs Transmitted
